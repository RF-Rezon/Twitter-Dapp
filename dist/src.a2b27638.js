...
var JSONABI = require("./abi.json");
var CONTRACTADDRESS = "0x5ccfe01fEdA08A0982128F3Daf7bA5cFb5E87641";
var web3 = new Web3(window.ethereum);
var contract = new web3.eth.Contract(JSONABI, CONTRACTADDRESS);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "12872" + '/');
